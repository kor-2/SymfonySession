 ...
 */
final class Version20220407091231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE programme (id INT AUTO_INCREMENT NOT NULL, module_formation_id INT NOT NULL, session_id INT DEFAULT NULL, nb_jour_module INT NOT NULL, INDEX IDX_3DDCB9FF3A53B0DC (module_formation_id), INDEX IDX_3DDCB9FF613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, formateur_id INT DEFAULT NULL, formation_id INT NOT NULL, nom VARCHAR(50) NOT NULL, debut DATE NOT NULL, fin DATE NOT NULL, nb_places INT NOT NULL, INDEX IDX_D044D5D4155D8F51 (formateur_id), INDEX IDX_D044D5D45200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stagiaire (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, sexe VARCHAR(20) NOT NULL, date_naissance DATE NOT NULL, ville VARCHAR(50) NOT NULL, mail VARCHAR(100) NOT NULL, telephone VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
